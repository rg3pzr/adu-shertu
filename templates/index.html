...
<body>
    ...
    <div id="game-screen" class="screen">
        <div class="game-header">
            ...
            <div class="game-info-bar">
                <div id="active-trump-info" class="info-pill hidden">
                    <span class="pill-label">Trump:</span>
                    <span id="display-trump-suit"></span> by <span id="display-trump-caller"></span>
                </div>
                <div id="active-challenge-info" class="info-pill hidden">
                    <span class="pill-label">Challenge:</span>
                    <span id="display-challenge-type"></span>
                </div>
            </div>
        </div>

        <div class="game-table">
            <div class="player-position pos-top">
                <div class="player-info" id="player-3">
                    <span class="player-name"></span>
                    <div class="player-cards"><span class="card-count">0</span> cards</div>
                </div>
            </div>
            <div class="player-position pos-top-left">
                <div class="player-info" id="player-2">
                    <span class="player-name"></span>
                    <div class="player-cards"><span class="card-count">0</span> cards</div>
                </div>
            </div>
            <div class="player-position pos-top-right">
                <div class="player-info" id="player-4">
                    <span class="player-name"></span>
                    <div class="player-cards"><span class="card-count">0</span> cards</div>
                </div>
            </div>
            <div class="player-position pos-left">
                <div class="player-info" id="player-1">
                    <span class="player-name"></span>
                    <div class="player-cards"><span class="card-count">0</span> cards</div>
                </div>
            </div>
            <div class="player-position pos-right">
                <div class="player-info" id="player-5">
                    <span class="player-name"></span>
                    <div class="player-cards"><span class="card-count">0</span> cards</div>
                </div>
            </div>
            <div id="player-0" class="hidden"></div>
        ...
        <div class="action-panel">
            <div id="trump-calling-actions" class="action-group hidden">
                ...
                <div class="suit-buttons">
                    <button class="btn-suit hearts" data-suit="♥">♥</button>
                    <button class="btn-suit diamonds" data-suit="♦">♦</button>
                    <button class="btn-suit clubs" data-suit="♣">♣</button>
                    <button class="btn-suit spades" data-suit="♠">♠</button>
                </div>
            ...
            <div id="challenge-actions" class="action-group hidden">
                ...
                <div id="ready-status-container" class="hidden" style="margin-top: 15px; text-align: center;">
                    <p style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 5px;">Waiting for everyone to continue...</p>
                    <div id="ready-players-list" class="ready-grid"></div>
                </div>
                <button id="proceed-stage2-btn" class="btn btn-primary hidden">Ready for Stage 2</button>
            </div>
    ...
    <div id="challenge-poll-modal" class="modal hidden">
        <div class="modal-content">
            <h3>Challenge Opportunity</h3>
            <p id="poll-text">Opponent has called Trump. Will your team challenge (Adu)?</p>
            <div class="button-group">
                <button onclick="sendPollResponse('yes')" class="btn btn-challenge">YES (ADU)</button>
                <button onclick="sendPollResponse('no')" class="btn btn-secondary">NO (PASS)</button>
            </div>
        </div>
    </div>
